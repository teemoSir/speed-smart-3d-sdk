 ...
 * Cartesian转为屏幕坐标
 *
 * @param {Cesium.Cartesian3} cartesian - Cartesian坐标
 * @param {Cesium.Scene} scene - Scene对象
 *
 * @return {Cesium.Cartesian2} 屏幕坐标
 */
export function cartesianToWindowPosition(cartesian, scene) {
