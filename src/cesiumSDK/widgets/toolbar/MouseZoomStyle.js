...
//鼠标旋转、放大时的美化图标
 class MouseZoomStyle {
  ...
  constructor(viewer, options) {
    ...
    var containerid = viewer._container.id + "-speed3d-mousezoom";
    zepto("#" + viewer._container.id).append(
      '<div id="' + containerid + '" class="speed3d-mousezoom"><div class="zoomimg"/></div>'
    );
    ...
    handler.setInputAction(evnet => {
      ...
      this._dom.addClass("speed3d-mousezoom-visible");
      clearTimeout(timetik);
      timetik = setTimeout(function() {
        that._dom.removeClass("speed3d-mousezoom-visible");
      }, 200);
    ...
    handler.setInputAction(
      evnet => {
        this._dom.removeClass("speed3d-mousezoom-visible");
        handler.setInputAction(evnet => {
          that._dom.css({
