...
class SyncViewer extends Speed  {
	constructor(viewerL, viewerR) {
	super(viewerL, viewerR)
	  this.viewer1 = viewerL;
	  this.viewer2 = viewerR;
	  this.focusIndex = 0;
	}
	...
	cancelSync() {
	  ...
	  this.viewer1.scene.postRender.removeEventListener(
	...
	syncEventHandler() {
	  this.isSync &&
		(this.focusIndex === 0 ? this.syncV2ToV1() : this.syncV1ToV2());
	}
