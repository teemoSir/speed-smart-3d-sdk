	...
	<div class="login_bg">
		<div class="login_adv" style="background-image: url(img/auth_banner.jpg);">
			<div class="login_adv__title">
				<h2>{process.env.VUE_APP_TITLE}三维GIS平台</h2>
...
<!--				</div>-->
			...
			<div class="login_adv__bottom">
				©Speed3D GIS Dev Platform V{{$CONFIG.APP_VER}}
			</div>
		</div>
...
<style scoped>
	...
	.login_adv__title h2 {font-size: 40px;color: #fff;}
	.login_adv__title h4 {font-size: 18px;margin-top: 10px;font-weight: normal;color: #fff;}
